...
### For Users
1.  Go to this repository's [Releases](https://github.com/99-Studios/spider-fun/releases).
2.  Download `Spider-FUN.exe` from the latest version
...
2. Type `pip install PyQt6` in your terminal. (Only if you haven't before!)
